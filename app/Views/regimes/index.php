        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($regimes as $r): ?>
                    <tr>
                        <td><?= esc($r['nom']) ?></td>
                        <td><?= esc($r['objectif_nom'] ?? ('#' . $r['objectifs_id'])) ?></td>
                        <td><?= esc($r['variation_poids']) ?></td>
                        <td><?= esc($r['pourcentage_viande']) ?>%</td>
                        <td><?= esc($r['pourcentage_poisson']) ?>%</td>
                        <td><?= esc($r['pourcentage_volaille']) ?>%</td>
                        <td>
